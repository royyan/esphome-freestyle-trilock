# custom_components/freestyle_lock/__init__.py
...
# Namespace must match your C++ namespace in freestyle_lock.h
...
# Define your custom config variables
CONF_BLE_MAC = "ble_mac"
CONF_AES_KEY = "aes_key"

# Full schema (extends standard lock schema + your custom fields)
...
async def to_code(config):
    ...
    # Call setter methods in your C++ class
